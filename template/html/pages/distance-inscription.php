			...
			<div class="content" >
				<form class="inscription-form" id='form-inscription' method="post" style="position: relative;">
                     <div class="title-line">
                      <h2>
                        <span  class="">
                         ...
                         <span class="other-title"><span class="title-itineraire"><?php echo get_the_title(get_post_field( 'post_parent', get_the_ID() , true ));?></span> <i class="fa fa-lg fa-angle-right" aria-hidden="true" ></i> <?php echo get_post_meta(get_the_ID(),'distance',true)?><!--  - Édition du <?php echo get_post_meta(get_the_ID(),'date_start',true) ?> --></span>
                      </h2>
                   </div>
                    ...
                    <div style="width: 90%;text-align: center;color: red;margin:20px 5%;">
                        Il reste <?php echo $number - $number_taken   ?> dossards disponibles pour cette course.
                    </div>
					...
					<div class="panel-container">
					    <div class="panel panel-default ">
					        <div class="panel-body form-horizontal">
					            ...
					            <div class="form-group">
					                <div class="" >
					                	<label for="club" class="control-label">Nom du club ou Nom de la TEAM </label>
