		...
		<div id="primary" class="col-md-12" ng-app="marathonapp">
			...
			<div class="head-template">
			   ...
			   <div class="col-md-6 col-sm-6 col-xs-12" id="results_header_subline">
			      ...
			      <p class="Cuprum" style="font-size: 10pt;margin-top: 2px;letter-spacing: 1px">Date de Fin des inscriptions - 
			          <?php echo get_post_meta($global_id,'date_end_subscribe',true) ?>
			      </p> 
			   ...
			   <div class="row">
			      <div class="col-xs-12">
			         <p class="alert alert-warning"> Course virtuelle : Les classements seront comptabilisés sur vos performances, le classement final sera publié le <?php echo get_post_meta($global_id,'date_end_',true); ?> à <?php echo get_post_meta($global_id,'time_end_',true) ?>
			         </p>
			      </div>
			   </div>
                ...
                <tbody>
                	...
                	// for ($i=0;$i<50;$i++) {
                		foreach ($participants as $key => $value) {
                			?>
							<tr>
		                        <td><?php echo intval( $value['dossard']); ?></td>
