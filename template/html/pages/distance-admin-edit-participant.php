...
foreach ($participants as $key => $value) {
   if($_GET['edit'] == hash('md5',$value['email']) ){
        $participant = $value;
        break;
   }
}
				...
				<form class="inscription-form" id='form-inscription' method="post" style="position: relative;">
					        ...
					        <div class="panel-body form-horizontal">
					            <div class="form-group">
					                <div class="">
					                    ...
					                    <input value="<?php echo $participant['name'];?>" name="name" title="Nom" class="form-control" maxlength="45" type="text" id="name" required="required" aria-required="true">
					                </div>
					                <div class="">
					                    <label for="datenaissance" class="control-label">Date de Naissance </label>
					                    <input value="<?php echo $participant['datenaissance'];?>" name="datenaissance" title="Date de naissance" class="form-control" type="date" id="datenaissance" required="required" > 
					                </div>
					            ...
					            <div class="form-group">
					                <div class="">
					                    ...
					                    <input value="<?php echo $participant['surname'];?>"  name="surname" title="Prénom" class="form-control"  type="text" id="UserName" required="required" aria-required="true">
					                </div>
					                <div class="">
					            ...
					            <div class="form-group">
					                ...
					                <div class="">
					                    <label for="email" class="control-label">Email </label>
					                   	<input value="<?php echo $participant['email'];?>" name="email" title="email" class="form-control" type="email" id="email" required="required" > 
                                ...
                                <div class="form-group">
                                    <div class="" >
                                        ...
                                        <input name="club" value="<?php echo $participant['club'];?>" title="confirm_email" class="form-control" type="text" id="club" required="required" > 
                                    </div>
                                    <div class="">
                                        <label for="email" class="control-label">Confirmation Email </label>
                                        <input name="confirm_email"  value="<?php echo $participant['email'];?>" title="confirm_email" class="form-control" type="email" id="confirm_email" required="required" > 
                                ...
                                <div class="form-group">
                                    <div class="" >
                                        ...
                                        <input name="dossard" value="<?php echo $participant['dossard'];?>" title="dossard" class="form-control" type="number" id="dossard" required="required" > 
                                    </div>
                                    <div class="">
                                        <label for="link" class="control-label"><a href="<?php echo $participant['link'];?>">Lien de confirmation</a> </label>
                                        <input name="link" value="<?php echo $participant['link'];?>" title="link" class="form-control" type="url" id="link"> 
                                ...
                                <div class="form-group">
                                    <div class="" >
                                        <label for="time" class="control-label">Temps du courreur </label>
                                        <input name="time" value="<?php echo $participant['time'];?>" title="time" class="form-control" type="time" step="1" id="time"  > 
                                    </div>
                                    <div class=""> 
					...
					<div class="panel-container" style="padding-bottom: 20px;">
					    <div class="panel panel-default " style="padding: 15px 20%;">
					        <div class="panel-body form-horizontal">
					            <div>
					            	<input type="checkbox" name="reglement" required=""> Je confirme vous  modifications apportees 
					            </div>
...
<script type="text/javascript">
    jQuery("form#form-inscription").submit(
        function(event){
            ...
            formData.append('function','updat_registration_event_admin');
