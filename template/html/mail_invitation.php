                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style="margin: 0 0 10px; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;">La Meute Running te félicite pour ton inscription</h1>
                                    <p style="margin: 0 0 10px;">Félicitation {Prenom} tu viens de t'inscrire à {Nom_de_la_Competition} sur le {distancekm}, quel beau défis ! Prouve à tous que le loup qui sommeil en toi peut faire des miracles.</p><br>
                                    <ul style="padding: 0; margin: 0; list-style-type: disc;">
										<li style="margin:0 0 5px 30px;" class="list-item-first">N'oublie pas de télécharger ton dossard pour te sentir comme en compétition</li>
										<li style="margin:0 0 30px 30px;">Une fois finis fait nous parvenir ton chronos via le formulaire prévu</li>
                                        <li style="margin:0 0 0px 30px;">Prend toi en photo sur avec ton dossard et identifie @lameuterunningteam pour que l'on puisse te mettre en avant </li>
									</ul>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                                        <tr>
                                            <td class="button-td button-td-primary" style="border-radius: 4px; background: #68119b ;">
                                                 <a class="button-a button-a-primary" href="{URL_Dossard}" style="background: #68119b ; border: 1px solid #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;">Télécharger mon dossard</a>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- Button : END -->
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    ...
                                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                                        <tr>
                                            <td class="button-td button-td-primary" style="border-radius: 4px; background: #68119b;">
                                                 <a class="button-a button-a-primary" href="{URL_Chronos}" style="background: #68119b; border: 1px solid #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;">Envoyer mes résultats</a>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- Button : END -->
